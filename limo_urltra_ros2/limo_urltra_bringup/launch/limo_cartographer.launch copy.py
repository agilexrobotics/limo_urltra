...
def generate_launch_description():
    ...
    rviz2_config = os.path.join(get_package_share_directory('limo_urltra_bringup'),'rviz','cartographer.rviz')
    ## ***** File paths ******
    ...
    cartographer_node = Node(
        ...
        arguments = [
            '-configuration_directory', FindPackageShare('limo_urltra_bringup').find('limo_urltra_bringup') + '/config_files',
